...
- 業種、決算、受注、受注残、株式需給リスク、銘柄一致を7層で監査する
...
4. FMPのニュース/プレスリリースから受注残、受注、契約、機関投資家買い、警戒見出しを更新
5. Recognition Gap EP候補を抽出
6. 7層評価ラベルを付与
7. opencode go合議用プロンプトを生成
8. 検出された全銘柄を5件ずつX用画像に分割して生成
9. `X_POST_ENABLED=true` の場合だけXへ投稿
...
6. 業績・受注確認: 売上、1株利益、構造変化、未確認なら保守的に扱う
