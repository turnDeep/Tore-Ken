...
- MiniMax: 価格、出来高、株式需給リスク、事業需給・受注の違和感チェック
...
- 出口判断はしない。出口はあらかじめ決めた機械ルールに任せる。
- ティッカー、会社名、業種が一致しないニュースは除外する。
- 価格が伸び切っていても、出来高維持と見立てが崩れていなければ「売り」と書かない。
- 「買い」「売り」「目標株価」ではなく、保有監視・乗り換え比較の質を書く。
- 出来高維持、上昇日出来高比、市場比の強さ、株式需給リスクを重視する。
- 「株式需給リスク」は、増資、売り出し、ワラント、転換社債、大株主売りなどの売り圧力を指す。
- 「事業需給・受注の強さ」は、受注、受注残、契約、顧客需要、生産能力不足などの本業側の需要を指す。
- 全銘柄に同じ説明を並べない。売上前年比、売上前期比、1株利益の前年比/前期比、加速/減速/改善/悪化、受注、契約、機関投資家買いなど、その銘柄だけの証拠を優先する。
- 1株利益は単体数値をそのまま書かない。前年比・前期比・前回からの変化方向がある時だけ書く。
- ニュース/プレスリリースは、入口日前60日、入口日から判定日、直近14日に分けて見る。要点には入口日以降と直近14日の重要材料を優先する。
...
- `半導体/AIデータセンター周辺。価格は大きく伸びているが崩れておらず、出来高も急騰起点後に持続。売上確認は次決算待ちだが、市場比の強さと業種文脈は明確。株式需給リスクが低ければ見立ての質は高く、出口は機械ルール優先。`
- `衛星/防衛寄りの小型テーマ株。出来高は持続し価格も強いが、規模が小さく株式需給リスクは監視。大化け色はある一方、事業需給・受注の裏取りが続くかが焦点。`
- `売上は前年同期比+105%、前期比+23%。1株利益も前年比・前期比とも加速しており、単なるテーマ物色より業績再評価として見やすい。`
- `売上は強いが1株利益は前年比・前期比とも悪化。契約ニュースはあるため事業需給は面白いが、利益化の遅れは別枠で監視。`
